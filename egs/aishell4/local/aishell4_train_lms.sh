...
kaldi_lm=$KALDI_ROOT/tools/kaldi_lm
if [ -z $kaldi_lm ]; then
...
cat $dir/unigram.counts  | awk '{print $2}' | $KALDI_ROOT/tools/kaldi_lm/get_word_map.pl "<s>" "</s>" "<UNK>" > $dir/word_map \
   || exit 1;
...
$KALDI_ROOT/tools/kaldi_lm/train_lm.sh --arpa --lmtype 3gram-mincount $dir || exit 1;
