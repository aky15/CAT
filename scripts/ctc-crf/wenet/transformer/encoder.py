...
class BaseEncoder(torch.nn.Module):
    def __init__(
        ...
        self.bypass_input_layer = bypass_input_layer
    ...
    def forward(
        ...
        if not self.bypass_input_layer:
        ...
        return xs, pos_emb, masks, chunk_masks
        ...
        for cur in range(0, num_frames - context + 1, stride):
            ...
            (y, subsampling_cache, elayers_output_cache,
             conformer_cnn_cache) = self.forward_chunk(chunk_xs, offset,
                                                       ...
                                                       conformer_cnn_cache)
            #print(len(conformer_cnn_cache))
            #print(subsampling_cache[0].shape)
            #print(elayers_output_cache[0].shape)
            #print(conformer_cnn_cache[0].shape)
            outputs.append(y)
            offset += y.size(1)
...
class TransformerEncoder(BaseEncoder):
    ...
    def __init__(
        ...
        super().__init__(input_size, output_size, attention_heads,
                         ...
                         global_cmvn, use_dynamic_left_chunk, bypass_input_layer)
